...
import { uploadSingle, uploadMultiple, uploadVideoFile, uploadAudioFile } from "../controllers/upload.controller";
...
router.post("/video", auth, requireAdmin, uploadVideo.single("video"), uploadVideoFile);
