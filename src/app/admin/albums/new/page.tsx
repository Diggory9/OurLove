...
import { createAlbum } from "@/lib/admin-api";
...
export default function NewAlbumPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await createAlbum({ title, description, coverImage, order });
      router.push("/admin/albums");
    } catch (err) {
      setError(err instanceof Error ? err.message : "Lỗi tạo album");
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Tạo album mới</h1>
